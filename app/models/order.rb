class Order < ApplicationRecord
  ...
  scope :finished_nochecks, -> { where("id in(select order_id From numbers where status=0) and state_cd>8 and orders.created_at>'2017-08-31'") }
  ...
  def pre_remark
    "完工微信联系【18037504462】或【17319724003】结算工时费； 要京东核销码。"
  end 
